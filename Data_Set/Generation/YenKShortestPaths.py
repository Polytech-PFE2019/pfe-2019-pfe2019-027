...
import heapq
from Data_Set.Generation.Dijkstra import Dijkstra
...
class YenKShortestPaths(object):
    ...
    def findFirstShortestPath(self, source, dest): 
        ...
        alg = Dijkstra(self.g, self.wt)
        #print('source',source,dest)
    ...
    def getNextShortestPath(self):
        ...
        while (curNode != self.dest):
            ...
            index = index + 1
            curNode = kNodes[index]
        #print('self.pathHeap',self.pathHeap)
        #print('len(self.pathHeap)',len(self.pathHeap))
...
#        List<E> ePath = alg.getPath(curNode, dest);
        ...
        alg = Dijkstra(self.tempG, self.wt)
...
class WeightedPath(object):
    ...
    def __str__(self):
        ...
        for name in  self.nodeList:
            ...
            #print name
            #print node
            nodenodeList.append(node)
        #print nodenodeList
        #return "nodeList: {}, cost: {}, capacity: {}".format(self.nodeList, self.cost, self.capacity)
        return "nodeList: {}, cost: {}, capacity: {}".format(nodenodeList, self.cost, self.capacity)
